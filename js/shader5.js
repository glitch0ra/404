...
document.addEventListener('DOMContentLoaded', () => {
    ...
    vec4 raymarchDisk(vec3 ray, vec3 zeroPos) {
        ...
        for(float i = 0.0; i < _Steps; i++) {
            ...
            // ИЗМЕНЕНО: Уменьшена агрессивность теней (было distMult *= distMult;)
            distMult = mix(1.0, distMult, 0.7); // 70% силы теней вместо 100%
            ...
            // ИЗМЕНЕНО: Уменьшена контрастность (было intensity * 2.5)
    ...
    void main() {
        ...
        // ИЗМЕНЕНО: Общая прозрачность колец снижена до 0.9
        fragColor.a *= 0.9;
    }
`;
